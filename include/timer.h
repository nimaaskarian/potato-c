...
char * Timer_time_left(const Timer *timer);
void Timer_pause(Timer * timer);
void Timer_unpause(Timer * timer);
void Timer_toggle_pause(Timer * timer);
void Timer_print_before_time(const Timer timer);
char * Timer_resolve_format(const Timer *timer, char const *format);
const char * Timer_before_time(const TimerType type);
void Timer_print_format(const Timer *timer, const char * format);
